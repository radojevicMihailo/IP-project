        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 content text-center">
                    <form name="forma_dodaj_radionicu" method="POST" action="./postani-organizator-skripta.php" enctype="multipart/form-data">
                        <table class="table table-borderless">
                            <tr>
                                <td colspan="2" class="text-center"><h2>Predloži radionicu</h2></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    <input type="submit" class="btn btn-primary" name="dugme_dodaj_radionicu" value="Predloži radionicu" />
                                </td>
                            </tr>
                        </table>
                    </form>
