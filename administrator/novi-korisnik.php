        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 content">
                    <form name="forma_registracija" method="POST" action="./novi-korisnik-skripta.php" enctype="multipart/form-data">
                        <table class="table table-borderless">
                          <tr>
                              <td colspan="2" class="text-center"><h2>Dodavanje novog korisnika</h2></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td class="text-start">
                              <input type="text" name="mat_br_org" />
                            </td>
                          </tr>
                          <tr>
                            <td colspan="2" class="text-center">
                                <input type="button" class="btn btn-primary" name="dugme_registracija" onclick="registracija()" value="Dodaj korisnika" />
                            </td>
                          </tr>
                        </table>
                    </form>
